...
//		assertEquals("abcdefghijklmno", t.toString());
	...
	@Test
	public void testInsertingIntoLast() {
		EditTree t = new EditTree();
		t.add('h'); // Insertion into last element
		t.add('d');
		t.add('l'); // Insertion into last element
		t.add('b');
		t.add('f');
		t.add('j');
		t.add('n'); // Insertion into last element
		t.add('a');
		t.add('c');
		t.add('e');
		t.add('g');
		...
		t.add('k');
		t.add('m');
		t.add('o'); // Insertion into last element
		assertEquals(0, t.totalRotationCount());
		assertEquals("abcdefghijklmno", t.toString());
		assertEquals(3, t.height());
